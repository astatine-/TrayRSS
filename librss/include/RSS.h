...
# define RSS_strspnp	wcsspn
# define RSS_strrev		wcsrev
#else /* char */
...
# define RSS_sprintf	sprintf_s
# define RSS_ctime		ctime
# define RSS_atoi		atoi
# define RSS_strrchr	strrchr
# define RSS_strspnp	strspn
# define RSS_strrev		strrev
# ifdef _WIN32
